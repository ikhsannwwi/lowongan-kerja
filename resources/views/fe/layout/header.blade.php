...
<head>
    <meta charset="utf-8">
    <title>@yield('title') - ikhsannawawi</title>
    ...
    <div class="container-fluid bg-primary text-white d-none d-lg-flex">
        <div class="container py-3">
            <div class="d-flex align-items-center">
                <a href="/">
                    <h2 class="text-white fw-bold m-0">Sanbray</h2>
                </a>
                <div class="ms-auto d-flex align-items-center">
                    <small class="ms-4"><i class="fa fa-map-marker-alt me-3"></i>Jalan Cimanuk no309A</small>
                    <small class="ms-4"><i class="fa fa-envelope me-3"></i>mochammadikhsannawawi@gmail.com</small>
                    <small class="ms-4"><i class="fa fa-phone-alt me-3"></i>+62 877 9888 9924</small>
                    <div class="ms-3 d-flex">
                        <a class="btn btn-sm-square btn-light text-primary rounded-circle ms-2" target="_blank" href="https://instagram.com/sanbray_"><i
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="/" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">Sanbray</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            'prosedur-perusahaan'
                            ) ? 'active' : ''}}" data-bs-toggle="dropdown">Prosedur</a>
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="/prosedur-melamar-kerja" class="dropdown-item">Prosedur Melamar Kerja</a>
                                <a href="/prosedur-perusahaan" class="dropdown-item">Prosedur untuk Perusahaan</a>
                            </div>
                        </div>
